"""ctypes declarations and constants for the tec5 SDACQ API.

These declarations are kept close to the vendor header naming so they can be
compared mechanically when a matching SDK header is available.
"""
